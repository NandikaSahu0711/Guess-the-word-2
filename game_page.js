...
function send(){
    ...
    remove_charAt1 = word.replace(charAt1, underscore);
    remove_charAt2 = remove_charAt1.replace(charAt2, underscore);
    remove_charAt3 = remove_charAt2.replace(charAt3, underscore);
